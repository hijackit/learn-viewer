...
var DragEvent = // coordinates of the initial drag event
...
function DragEvent(type, x, y, initialDrag, lastDrag) {
  ...
  _defineProperty(this, "initialDragEventX", 0);

  _defineProperty(this, "initialDragEventY", 0);
...
var Panel = /*#__PURE__*/function () {
  ...
  function Panel(canvas) {
    ...
    _defineProperty(this, "imageRotation", 0);
  ...
  _createClass(Panel, [{
    ...
    value: function translate(deltaX, deltaY) {
      var rotationMatrix = Object(transformation_matrix__WEBPACK_IMPORTED_MODULE_0__["inverse"])(Object(transformation_matrix__WEBPACK_IMPORTED_MODULE_0__["rotateDEG"])(this.imageRotation));
      var rotatedPoint = Object(transformation_matrix__WEBPACK_IMPORTED_MODULE_0__["applyToPoint"])(rotationMatrix, [deltaX, deltaY]);
    ...
    value: function zoom(amount, canvasX, canvasY) {
      ...
      var imageZoomPoint = this.toImagePoint(canvasZoomPoint);
      console.log('zooming on', imageZoomPoint); // first change the scale, then we can compute the point on canvas after zoom

      this.imageScale = newScale;
      var canvasPointAfterZoom = this.toCanvasPoint(imageZoomPoint); // translate back the image

      var deltaX = canvasPointAfterZoom.x - canvasZoomPoint.x;
      var deltaY = canvasPointAfterZoom.y - canvasZoomPoint.y;
    ...
    value: function getTransformationMatrix() {
      return Object(transformation_matrix__WEBPACK_IMPORTED_MODULE_0__["compose"])(Object(transformation_matrix__WEBPACK_IMPORTED_MODULE_0__["rotate"])(this.imageRotation * Math.PI / 180, this.canvas.width / 2, this.canvas.height / 2), Object(transformation_matrix__WEBPACK_IMPORTED_MODULE_0__["translate"])(this.imageTx, this.imageTy), Object(transformation_matrix__WEBPACK_IMPORTED_MODULE_0__["scale"])(this.imageScale));
    }
    /**
    ...
    value: function toImagePoint(canvasPoint) {
      var matrix = Object(transformation_matrix__WEBPACK_IMPORTED_MODULE_0__["inverse"])(this.getTransformationMatrix());
    ...
    value: function render(ctx) {
      ...
      ctx.translate(-this.canvas.width / 2, -this.canvas.height / 2); // translation

      ctx.translate(this.imageTx, this.imageTy); // scale
...
document.addEventListener('keydown', function (e) {
  if (e.code === "ArrowLeft") panel.rotate(-10);else if (e.code === "ArrowRight") panel.rotate(10);
});
